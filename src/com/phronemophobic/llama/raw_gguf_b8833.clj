(ns com.phronemophobic.llama.raw-gguf-b8833
    ...
    (with-open [w (io/writer outf)]
      (write-edn w
                 ((requiring-resolve 'com.phronemophobic.clong.clang/easy-api)
                  ...
                  "/Users/adrian/workspace/llama.cpp/include/llama.h"
                  (into default-arguments
                        ["-I/Users/adrian/workspace/llama.cpp/ggml/include"]))))))

(def raw-api
  #_((requiring-resolve 'com.phronemophobic.clong.clang/easy-api) "/Users/adrian/workspace/llama.cpp/llama.h")
  (with-open [rdr (io/reader
                     (io/resource
                      "com/phronemophobic/llama/api-gguf-b8833.edn"))
...
(defn ^:private create-context
  ...
  ([model-path params]
   ...
   (let [
         ...
         _ (println llama-context-params)
